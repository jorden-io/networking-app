import {
  ...
  export class userResolvers {
    ...
    myTasks(@Ctx() { payload }: MyContext) {
      return Task.find({ where: { your_id: payload!.userID } });
    }
    ...
    async register(
      ...
      @Arg("firstName", () => String) first_name: string,
      @Arg("lastName", () => String) last_name: string,
      @Arg("userName", () => String) user_name: string
    ) {
